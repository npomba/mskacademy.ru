...
export { default as phoneNumberKK } from '@/config/phoneNumberKK'
...
export { default as defaultDescription } from '@/config/defaultDescription'
export { default as sessionStorageKeys } from '@/config/sessionStorageKeys'
